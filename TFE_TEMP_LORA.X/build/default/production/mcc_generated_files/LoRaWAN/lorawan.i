...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/LoRaWAN/lorawan.c" 2
# 29 "mcc_generated_files/LoRaWAN/lorawan.c"
# 1 "mcc_generated_files/LoRaWAN/lorawan.h" 1
# 38 "mcc_generated_files/LoRaWAN/lorawan.h"
...
# 38 "mcc_generated_files/LoRaWAN/lorawan.h" 2
...
# 39 "mcc_generated_files/LoRaWAN/lorawan.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\stdbool.h" 1 3
# 40 "mcc_generated_files/LoRaWAN/lorawan.h" 2
...
# 41 "mcc_generated_files/LoRaWAN/lorawan.h" 2
...
# 42 "mcc_generated_files/LoRaWAN/lorawan.h" 2
...
# 43 "mcc_generated_files/LoRaWAN/lorawan.h" 2
...
# 33 "mcc_generated_files/LoRaWAN/lorawan.c" 2

# 1 "mcc_generated_files/LoRaWAN/radio_interface.h" 1
# 49 "mcc_generated_files/LoRaWAN/radio_interface.h"
...
# 49 "mcc_generated_files/LoRaWAN/radio_interface.h" 2
# 34 "mcc_generated_files/LoRaWAN/lorawan.c" 2

# 1 "mcc_generated_files/LoRaWAN/sw_timer.h" 1
...
# 35 "mcc_generated_files/LoRaWAN/lorawan.c" 2

# 1 "mcc_generated_files/LoRaWAN/interrupt_manager_lora_addons.h" 1
# 58 "mcc_generated_files/LoRaWAN/interrupt_manager_lora_addons.h"
volatile uint8_t dioStatus;
# 75 "mcc_generated_files/LoRaWAN/interrupt_manager_lora_addons.h"
uint8_t INTERRUPT_GetDioStatus(void);
# 91 "mcc_generated_files/LoRaWAN/interrupt_manager_lora_addons.h"
...
# 36 "mcc_generated_files/LoRaWAN/lorawan.c" 2
...
# 37 "mcc_generated_files/LoRaWAN/lorawan.c" 2


# 1 "mcc_generated_files/LoRaWAN/lorawan_eu.h" 1
# 84 "mcc_generated_files/LoRaWAN/lorawan_eu.h"
typedef union
{
...
typedef struct
{
    ...
    uint8_t offset;
    _Bool macInitialized;
    _Bool rx2DelayExpired;
    _Bool abpJoinStatus;
...
extern LoRa_t loRa;
# 39 "mcc_generated_files/LoRaWAN/lorawan.c" 2
# 51 "mcc_generated_files/LoRaWAN/lorawan.c"
...
static void AssemblePacket (_Bool confirmed, uint8_t port, uint8_t *buffer, uint16_t bufferLength);

static _Bool FindSmallestDataRate (void);
...
LorawanError_t LORAWAN_Send (TransmissionType_t confirmed, uint8_t port, void *buffer, uint8_t bufferLength)
 {
    ...
    if (loRa.fCntUp.value == (0xffffffffu))
    {
...
void LORAWAN_GetMcastApplicationSessionKey (uint8_t *mcastApplicationSessionKey)
{
    if (mcastApplicationSessionKey != ((void*)0))
    {
...
void LORAWAN_GetMcastNetworkSessionKey (uint8_t *mcastNetworkSessionKey)
{
    if (mcastNetworkSessionKey != ((void*)0))
    {
...
void LORAWAN_SetNetworkSessionKey (uint8_t *networkSessionKeyNew)
{
   if (networkSessionKeyNew != ((void*)0))
   {
...
void LORAWAN_SetApplicationSessionKey (uint8_t *applicationSessionKeyNew)
{
    if (applicationSessionKeyNew != ((void*)0))
    {
        ...
        if((RADIO_GetStatus() & (1 << (1))) == 0)
        {
            ...
            if (CLASS_A == loRa.deviceClass)
            {
                if (RADIO_ReceiveStart(rxWindowSize[loRa.receiveWindow2Parameters.dataRate]) != OK)
                {
                    ...
                    if (rxPayload.RxAppData != ((void*)0))
                    {
                        rxPayload.RxAppData (((void*)0), 0, MAC_NOT_OK);
                    }
                }
            }
            else
    ...
    if (loRa.macStatus.macPause == 0)
    {
         if (loRa.counterRepetitionsConfirmedUplink <= loRa.maxRepetitionsConfirmedUplink)
         {
                ...
                else
                {
                    ...
                    if (rxPayload.RxAppData != ((void*)0))
                    {
                        rxPayload.RxAppData(((void*)0), 0, INVALID_BUFFER_LEN);
                    }
                }
            }
...
void UpdateJoinSuccessState(uint8_t param)
{
    ...
    if (rxPayload.RxJoinResponse != ((void*)0))
    {
...
LorawanError_t LORAWAN_RxDone (uint8_t *buffer, uint8_t bufferLength)
{
    ...
    if (loRa.macStatus.macPause == 0)
    {
        ...
        else if ( (mhdr.bits.mType == FRAME_TYPE_DATA_UNCONFIRMED_DOWN) || (mhdr.bits.mType == FRAME_TYPE_DATA_CONFIRMED_DOWN) )
        {
            ...
            if ( (CLASS_C == loRa.deviceClass) && (hdr->members.devAddr.value == loRa.activationParameters.mcastDeviceAddress.value) && (1 == loRa.macStatus.mcastEnable) )
            {
                ...
                if (hdr->members.fCnt >= loRa.fMcastCntDown.members.valueLow)
                {
                    if ( (hdr->members.fCnt - loRa.fMcastCntDown.members.valueLow) > loRa.protocolParameters.maxMultiFcntGap )
                    {
                        if (rxPayload.RxAppData != ((void*)0))
                        {
                            rxPayload.RxAppData (((void*)0), 0, MCAST_RE_KEYING_NEEDED);
                        }
                ...
                if (loRa.fMcastCntDown.value == (0xffffffffu))
                {
                    if (rxPayload.RxAppData != ((void*)0))
                    {
                        rxPayload.RxAppData (((void*)0), 0, MCAST_RE_KEYING_NEEDED);
            ...
            if (loRa.fCntDown.value == (0xffffffffu))
            {
...
static void SetReceptionNotOkState (void)
{
    if ( (loRa.macStatus.macState == RX2_OPEN) || ( (loRa.macStatus.macState == RX1_OPEN) && (loRa.rx2DelayExpired) ) )
    {
        ...
        if ((loRa.deviceClass == CLASS_A) && (rxPayload.RxAppData != ((void*)0)))
        {
            loRa.lorawanMacStatus.synchronization = 0;
            rxPayload.RxAppData (((void*)0), 0, MAC_NOT_OK);
        }
...
static uint8_t CheckMcastFlags (Hdr_t* hdr)
{
# 2108 "mcc_generated_files/LoRaWAN/lorawan.c"
